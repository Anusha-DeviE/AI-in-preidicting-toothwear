...
def image():
    if request.method == 'POST':
        ...
        predicted_class, accuracy = predict_image("static/images/"+fileName)
        ...
        return render_template('results.html', 
                               status=str_label,
                               status2=f'accuracy is {accuracy}',
                               ...
                               ImageDisplay4="http://127.0.0.1:5000/static/teeth.jpg")
